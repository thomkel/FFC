...
class DemandsControllerTest < ActionController::TestCase
  ...
  test "should create demand" do
    assert_difference('Demand.count') do
      post :create, demand: { integer: @demand.integer, integer: @demand.integer, integer: @demand.integer, integer: @demand.integer }
    end
  ...
  test "should update demand" do
    patch :update, id: @demand, demand: { integer: @demand.integer, integer: @demand.integer, integer: @demand.integer, integer: @demand.integer }
    assert_redirected_to demand_path(assigns(:demand))
  end
